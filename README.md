...
- 📡 [DC Hub](https://dchub.cloud) - Live physical-infrastructure intelligence: 21,000+ data centers, real-time power-grid telemetry for 10 ISOs, fiber routes, gas economics, and 2,000+ tracked deals. *Use case: Checking grid headroom before siting a data center, ranking markets by the DC Hub Power Index, and pulling recent hyperscaler deals — inline in chat.*
